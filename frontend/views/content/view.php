...
$this->registerMetaTag([
    'name' => 'description',
    'content' => $articles[0]['seo_description']
]);
$this->registerMetaTag([
    'name' => 'keywords',
    'content' => $articles[0]['seo_keywords']
]);



$this->title = $articles[0]['seo_title'];

$art = Articles::find()->where(['page' => $url_p])->all();


if ($url_p == 'markets' || $_SERVER['REQUEST_URI'] == '/markets/birgsale' || $_SERVER['REQUEST_URI'] == '/markets'){
...
<div class="row blocks-list">
    ...
    <div class="col-lg-9 _layout blocks-list__item">
                                    ...
                                    <div class="sidebar-list _gray _border">
                                        ...
                                        foreach ($art as $article) {
                                            if ($article['name'] == 'Зерновые культуры и продукты их переработки' || $article['name'] == 'Газ' || $article['name'] == 'Нефтепродукты'){
                                                ?>
                                                <a href="<?="/".$url_p."/".$article['url']?>" style="padding-left: 20px" class="sidebar-list__item"><div class="sidebar-list__item-inner">
                                                ...
                                                ?>
                                                <a href="<?="/".$url_p."/".$article['url']?>" class="sidebar-list__item"><div class="sidebar-list__item-inner">
                                                            <span class="sidebar-list__text">
                                                                <div class="sidebar-list__link"><?=$article['name']?></div>
                                                            </span>
                                                    </div>
        ...
        ?>
<?
if ($_SERVER['REQUEST_URI'] == '/press/newsbirga'){
    ?>
    </div>
        <div class="_layout blocks-list__item col-lg-39" style="padding-right: 10px;padding-top: 10px;">
            <div class="blocks-list">
                        ...
                        <div class="blocks-list__item hidden-xs">
                            <div class="row">
                                <div class="col-sm-28"><ol class="breadcrumb">
                                        ...
                                        <li><?=$articles[0]['name']?></li></ol></div>
                            </div>
                        </div>
                        <div class="text-block"><h1 class="news_title" style="padding-top:0px;"><?=$articles[0]['name']?></h1>
    ...
    <?
}else if($_SERVER['REQUEST_URI'] == '/press/marketsnews'){
    ?>
        </div>
        <div class="_layout blocks-list__item col-lg-39" style="padding-right: 10px;padding-top: 10px;">
            <div class="blocks-list">
