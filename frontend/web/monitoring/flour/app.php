...
//код карты
	...
	echo '<h4 style="text-align: center;"><strong>Моніторинг ринкових цін на борошно вищого та першого гатунків (базис EXW)</strong></h4>';
		echo '<div id="map" style="width: 98%; height: 408px;"></div>';
		    echo '<br><br><strong>&nbsp;&nbsp; (!) Для того, аби скористатися можливістю перегляду інформації про ринкові ціни, Вам необхідно:<br></strong><br>';
            echo '&nbsp;&nbsp; - обрати на мапі регіон, який Вас цікавить;<br>';
            echo '&nbsp;&nbsp; - після того, як буде відкрито обраний Вами регіон - необхідно у лівій частині графіку розділу "Select" обрати вид продукції, ціни якої Вас цікавлять;<br>';
            echo '&nbsp;&nbsp; - якщо Вас додатково цікавить для порівняння інший вид продукції або уся наявна продукція - у розділі "Compare to" необхідно зробити відповідне виділення;<br>';
            echo '&nbsp;&nbsp; - у розділі "From" Ви маєте можливість обрати період, протягом якого бажаєте порівняти ціни на продукцію;<br>';
            echo '&nbsp;&nbsp; - розділ "Zoom" відповідає за демонстрацію цін по періодам (1 місяц, 1 рік, усі наявні періоди).<br><br>';
            echo '&nbsp;&nbsp; <strong>(!!) Наразі доступна інформація про ціни починаючи з початку 2017 року.<br><br></strong>';
            echo '&nbsp;&nbsp; <strong>(!!!) Зверніть увагу! Ціни у вихідні дні відображають показник попереднього робочого дня.<br><br><br></strong>';
	echo '</body>';
echo '</html>';
...
echo "\n";
echo '<style> #chartdiv { width: 99%; height: 500px;} </style>';
echo "\n";
...
echo '<h4 style="text-align: center;"><strong>Моніторинг ринкових цін на борошно вищого та першого гатунків (базис EXW)<br></strong></h4>';
...
echo '<p style="text-align: center;"><a href=app.php>повернутися до мапи</a></strong>';
echo '<p style="text-align: left;"> </p>';
echo '<img src="data/space.gif" width=500px height=1px>';
		    echo '<br><strong>&nbsp;&nbsp; (!) Для того, аби скористатися можливістю перегляду інформації про ринкові ціни, Вам необхідно:<br></strong><br>';
            echo '&nbsp;&nbsp; - обрати на мапі регіон, який Вас цікавить;<br>';
            echo '&nbsp;&nbsp; - після того, як буде відкрито обраний Вами регіон - необхідно у лівій частині графіку розділу "Select" обрати вид продукції, ціни якої Вас цікавлять;<br>';
            echo '&nbsp;&nbsp; - якщо Вас додатково цікавить для порівняння інший вид продукції або уся наявна продукція - у розділі "Compare to" необхідно зробити відповідне виділення;<br>';
            echo '&nbsp;&nbsp; - у розділі "From" Ви маєте можливість обрати період, протягом якого бажаєте порівняти ціни на продукцію;<br>';
            echo '&nbsp;&nbsp; - розділ "Zoom" відповідає за демонстрацію цін по періодам (1 місяц, 1 рік, усі наявні періоди).<br><br>';
            echo '&nbsp;&nbsp; <strong>(!!) Наразі доступна інформація про ціни починаючи з початку 2017 року.<br><br></strong>';
            echo '&nbsp;&nbsp; <strong>(!!!) Зверніть увагу! Ціни у вихідні дні відображають показник попереднього робочого дня.<br><br></strong>';
            echo '<img src="data/space.gif" width=500px height=1px>';
echo '</body></html>';
